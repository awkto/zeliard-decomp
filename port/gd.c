...
const GdArt GD_ART[] = {
 ...
 /* the tails are enddemo's 0xBn / 0x8n lip-sync banks (658C / 6568) */
 { "himp.grp",  0, 0x11, 0, 6, { P(0,24,88,GDM_P3,1,0), P(0x18C0,9,24,GDM_P3,6,648),
                                 P(0x27F0,10,24,GDM_P3,3,720) }, 3 },
 { "seip.grp",  0, 0x1D, 0, 6, { P(0,24,88,GDM_P3,1,0), P(0x18C0,7,24,GDM_P3,6,504) }, 2 },
